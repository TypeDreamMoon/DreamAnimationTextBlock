...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="DreamTextBlock|Text")
	void SetText(FText InText, bool bInitializeAnimation = false);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="DreamTextBlock|Text")
	void SetTextAndPlayAnimation(FText InText);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="DreamTextBlock|Animation")
	 ...
	 * @return 当前文本的字符数量
	 */
	UFUNCTION(BlueprintPure, Category="DreamTextBlock|Text")
	 ...
	 * @return 当前字体信息
	 */
	UFUNCTION(BlueprintPure, Category="DreamTextBlock|Appearance")
	 ...
	 * 字符动画开始播放时触发的事件。
	 */
	UPROPERTY(BlueprintAssignable, Category="DreamTextBlock|Events")
...
protected:
	 ...
	 */
	virtual void Internal_SetText(FText InText, bool bInitializeAnimation = false);

protected:
	/**
	 * 所有字符控件的数组。
	 */
	UPROPERTY(BlueprintReadOnly, Category="DreamTextBlock|Internal")
